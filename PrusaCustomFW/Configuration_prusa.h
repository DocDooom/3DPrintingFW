...
#ifdef SNMM
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100, 4000,140} //100, 100, 3200/8, 140
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80, 4000, 104} //100, 100, 3200/8, 161.3
#endif
...
#define DIGIPOT_MOTOR_CURRENT_LOUD {155,155,155,155,155}

// Motor Current settings for RAMBo mini PWM value = MotorCurrentSetting * 255 / range
#if MOTHERBOARD == 102 || MOTHERBOARD == 302  || MOTHERBOARD == BOARD_MKS_BASE 
//#define MOTOR_CURRENT_PWM_RANGE 2000
#define DEFAULT_PWM_MOTOR_CURRENT  {270, 1300, 450} // {XY,Z,E} was set to - 270, 830, 450
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 1300, 500} // {XY,Z,E} - was set to 540, 830, 500
#endif

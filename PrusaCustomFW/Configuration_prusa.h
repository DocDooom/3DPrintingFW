...
#define DEFAULT_PWM_MOTOR_CURRENT  {170, 400, 400} // {XY,Z,E} was set to - 270, 830, 450
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {240, 400, 400} // {XY,Z,E} - was set to 540, 830, 500
#endif
